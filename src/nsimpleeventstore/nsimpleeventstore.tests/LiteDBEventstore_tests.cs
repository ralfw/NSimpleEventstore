...
{
    public class LiteDBEventstore_tests
    {
        ...
        {
            const string PATH = nameof(LiteDBEventstore_tests) + "_" + nameof(Basic_recording_and_replaying);
            RemoveDB(PATH);
            var sut = new LiteDBEventstore(PATH);
        ...
        {
            const string PATH = nameof(LiteDBEventstore_tests) + "_" + nameof(Version_number_changes);
            RemoveDB(PATH);
            var sut = new LiteDBEventstore(PATH);
        ...
        {
            const string PATH = nameof(LiteDBEventstore_tests) + "_" + nameof(Notification_about_events_recorded);
            RemoveDB(PATH);
            var sut = new LiteDBEventstore(PATH);
        ...
        {
            const string PATH = nameof(LiteDBEventstore_tests) + "_" + nameof(Replaying_a_subset);
            RemoveDB(PATH);
            var sut = new LiteDBEventstore(PATH);
        ...
        {
            const string PATH = nameof(LiteDBEventstore_tests) + "_" + nameof(Replaying_from_event_number);
            RemoveDB(PATH);
            var sut = new LiteDBEventstore(PATH);
        ...
        {
            const string PATH = nameof(LiteDBEventstore_tests) + "_" + nameof(Recording_succeeds_with_right_version);
            RemoveDB(PATH);
            var sut = new LiteDBEventstore(PATH);
        ...
        {
            const string PATH = nameof(LiteDBEventstore_tests) + "_" + nameof(Recording_fails_with_wrong_version);
            RemoveDB(PATH);
            var sut = new LiteDBEventstore(PATH);
        ...
        {
            const string PATH = nameof(LiteDBEventstore_tests) + "_" + nameof(Replay_in_the_right_order_with_many_events);
            RemoveDB(PATH);
            var sut = new LiteDBEventstore(PATH);
